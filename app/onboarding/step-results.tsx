...
const COUNTRY_DATA: Record<string, CountryInfo> = {
  GB: {
    ...
    obligations: [
      "Self Assessment tax return (SA100) — covers ALL income",
      "Capital gains on crypto disposals (SA108)",
      "Capital gains on stock/ETF sales (SA108)",
      "Self-employment income reporting (SA103)",
      "Split-year treatment claim if you left the UK mid-year",
      "Dividend income above £1,000 allowance",
    ],
    myth: {
      myth: "You only pay tax when you cash out to GBP.",
      reality:
        "Every crypto-to-crypto trade is a taxable disposal in the UK. The same applies to stock and ETF sales — any disposal is a chargeable event.",
    },
    docs: [
      "Exchange transaction history (CSV exports)",
      "Brokerage annual statements (stocks, ETFs, dividends)",
      "Employment payslips and P60/P45",
      "Self-employment accounts and invoices",
      "Wallet addresses for on-chain transactions",
      "DeFi protocol interaction records",
      "Cost basis records for all asset purchases",
  ...
  US: {
    ...
    obligations: [
      "Worldwide income reporting (Form 1040)",
      "Crypto disposals (Form 8949 + Schedule D)",
      "Stock sales and dividends (Form 8949 + 1099-DIV)",
      "Foreign bank accounts over $10,000 (FBAR / FinCEN 114)",
      "Foreign financial assets over $50,000 (FATCA Form 8938)",
      "Self-employment tax (Schedule SE)",
    ],
    myth: {
      myth: "If I didn't receive a 1099, I don't need to report.",
      reality:
        "The IRS requires reporting all income and disposals regardless of whether you received tax forms — crypto, stocks, and foreign income included.",
    },
    docs: [
      "Exchange transaction history (CSV exports)",
      "Brokerage 1099-B and 1099-DIV statements",
      "W-2 forms for employment income",
      "1099-NEC/1099-MISC for self-employment",
      "Wallet addresses for on-chain transactions",
      "Foreign bank account statements for FBAR",
      "Cost basis records for all asset purchases",
      "Previous tax returns (if amending)",
  ...
  AU: {
    ...
    obligations: [
      "Individual tax return — all income sources",
      "Capital gains on crypto (50% CGT discount if held 12+ months)",
    ...
    myth: {
      ...
      reality:
        "There is no minimum threshold — all capital gains from crypto and shares are taxable in Australia.",
    },
    docs: [
      "Exchange transaction history (CSV exports)",
      "Share trading statements from brokers",
      "Employment payment summaries / income statements",
  ...
  CA: {
    ...
    obligations: [
      ...
      "Stock and ETF capital gains on Schedule 3",
      "Business income rules if trading is frequent",
      "T1 General return with all income sources",
      "Foreign property reporting (T1135) if over $100K",
    ],
    myth: null,
    docs: [
      "Exchange transaction history (CSV exports)",
      "Brokerage T5008 slips",
  ...
  DE: {
    ...
    obligations: [
      ...
      "Crypto: tax-free if held over 1 year (§23 EStG)",
      "Stock gains: 25% flat tax (Abgeltungssteuer) + solidarity surcharge",
      "Foreign employment income with progression clause",
      "Self-employment (Gewerbeanmeldung may be required)",
    ],
    myth: {
      myth: "All crypto is tax-free in Germany.",
      reality:
        "Only crypto holdings sold after 1+ year are exempt. Short-term gains are fully taxable. Stock gains are always taxed at 25% flat rate.",
    },
    docs: [
      "Exchange transaction history (CSV exports)",
      "Brokerage annual tax statements (Jahressteuerbescheinigung)",
      "Employment income records (Lohnsteuerbescheinigung)",
  ...
  FR: {
    ...
    obligations: [
      "Flat tax of 30% (PFU) on crypto and investment gains",
      "Form 2086 for crypto disposals",
      "Stock and ETF gains declaration",
      "Employment income declaration",
      "Must declare all foreign exchange and bank accounts (Form 3916-bis)",
    ...
    docs: [
      ...
      "Wallet addresses for on-chain transactions",
      "Foreign bank account details for Form 3916-bis",
      "Cost basis records for all asset purchases",
      "Previous tax returns (if amending)",
  ...
  SE: {
    ...
    obligations: [
      ...
      "Stock and fund gains on K4 attachment",
      "Employment income declaration",
    ...
    docs: [
      "Exchange transaction history (CSV exports)",
      "Brokerage annual statements (kontrolluppgifter)",
  ...
  DK: {
    ...
    obligations: [
      ...
      "Stock gains taxed under share income rules (27%/42%)",
  ...
  IT: {
    ...
    obligations: [
      "26% substitute tax on crypto and financial capital gains",
      "€2,000 de minimis threshold removed from 2023",
      "Stock/ETF gains taxed at 26%",
      "RW form for foreign asset monitoring",
      "IVAFE tax on foreign financial assets",
      "Employment and self-employment income declaration",
    ],
    myth: null,
    docs: [
      "Exchange transaction history (CSV exports)",
      "Brokerage annual statements",
      "Employment CU (Certificazione Unica)",
      "Wallet addresses for on-chain transactions",
      "Foreign bank and brokerage account details",
      "Cost basis records for all asset purchases",
      "Previous tax returns (if amending)",
  ...
  PT: {
    ...
    obligations: [
      "IRS Modelo 3 annual declaration",
      "Crypto gains: 28% tax on holdings under 365 days",
      "Stock/ETF gains: 28% tax rate",
      "NHR regime: potential exemption on foreign-source income",
      "Foreign company income: NHR treatment for Estonian e-Residency",
    ],
    myth: {
      myth: "Portugal doesn't tax crypto.",
      reality:
        "Since 2023, Portugal taxes crypto gains at 28% for holdings under 365 days. Stock gains are also taxed at 28%. NHR may exempt some foreign income.",
    },
    docs: [
      "Exchange transaction history (CSV exports)",
      "Brokerage annual statements",
      "Foreign employment contracts and payslips",
      "Foreign company annual accounts (e.g., Estonian e-Residency)",
      "Wallet addresses for on-chain transactions",
      "NHR status documentation",
      "Cost basis records for all asset purchases",
      "Previous tax returns (if amending)",
  ...
  ES: {
    ...
    obligations: [
      ...
      "Stock and ETF gains taxed at savings rates (19–28%)",
    ...
    docs: [
      ...
      "Brokerage annual statements",
      "Employment income records",
      "Self-employment invoices and records",
      "Wallet addresses for on-chain transactions",
      "Cost basis records for all asset purchases",
      "Previous tax returns (if amending)",
      ...
      {submitted ? (
        ...
        <>
          ...
          <div className="mt-8 bg-gradient-to-r from-teal/10 to-teal/5 border border-teal/20 rounded-xl p-6 text-center">
            ...
            <p className="text-sm text-gray-400 mb-5">
              Connect with a tax professional who understands every income type
